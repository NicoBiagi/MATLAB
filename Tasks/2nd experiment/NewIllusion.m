...
run_info = inputdlg(prompt, 'Info', 1, {'NI_', '1', 'Y'});
SubID = run_info{1};
...
% trialList(1:12)= +1; %pointing right >->
% trialList(13:24)= -1; %pointing left <-<
% 
...
dataFileName2 = ['ID-' SubID '-NewIllusion-' DateT '-Session-' SessionNo];
