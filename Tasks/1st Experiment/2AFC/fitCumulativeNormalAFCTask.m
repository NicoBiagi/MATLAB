...
forPalymedes = importdata('2AFC-ID-19-21-Mar-2018-Session-2-PAL.txt'); % this line of codes works to import a space delimited text file with no header row from the working directory
...
OutputFileName = ['2AFC-ID-' ID '-' DateT '-Session-' Session '-fitted'];%no need to include .txt at the end. it will be added when the file is saved

observer = ['2AFC-ID-' ID '-' DateT '-Session-' Session]; % title for graph DF
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
xlabel('Angle as % of interval 1 angle');
ylabel('% Larger judgements');
